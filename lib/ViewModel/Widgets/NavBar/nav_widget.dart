...
class CodingWithZohaibBottomBar extends StatelessWidget {
  /// A bottom bar that faithfully follows the design by CodingWithZohaib
  const CodingWithZohaibBottomBar({
    Key? key,
    required this.items,
  ...
  final List<CodingWithZohaibBottomBarItem> items;
...
/// A tab to display in a [CodingWithZohaibBottomBar]
class CodingWithZohaibBottomBarItem {
  /// An icon to display.
  final Widget icon;
